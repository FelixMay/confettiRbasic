...
plot(sim1$summary.stats$nSpecies ~ sim1$generations,type="l",
...
SAR.dat <- data.frame(nSpec = as.numeric(sim1$summary.stats$SAR),
                      Area_ha = rep(sim1$summary.stats$Area / 1e4, each = n.timesteps),
...
```{r, fig.width = 6, fig.height = 5}
Fr.dat <- data.frame(Fr = as.numeric(sim1$summary.stats$Fr),
                     radius = rep(sim1$summary.stats$radius, each = n.timesteps),
                     Time = sim1$generations) 
...
plot(sim2$summary.stats$nSpecies ~ sim2$generations, type="l",
     xlab = "Time [in generations]",
     ylab = "No. of species", las = 1)

plot(sim2$summary.stats$Shannon ~ sim2$generations,type="l",
     xlab = "Time [in generations]",
     ylab = "Shannon diversity", las = 1)

plot(sim2$summary.stats$Simpson ~ sim2$generations,type="l",
     xlab = "Time [in generations]",
