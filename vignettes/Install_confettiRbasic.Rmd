...
And here is another example for a logarithmic trade-off between CNDD and relative metacommunity abundance. In this case you have to use a log-normal SAD for the metacommunity, i.e. `meta.SAD = 1`. Otherwise all species have the same relative abundance in the metacommunity and then also the same CNDD.
